...
public class LoginAndLogout extends Base {
	...
	public void tearDown() throws InterruptedException {
		...
		/*
		 * homePage.clickonLogoutwithPunchoutOption(); homePage.clickOnLogout();
		 * Thread.sleep(3000);
		 */
		driver.quit();
	}
	...
	public void verifyLoginWithValidCredential(String email, String password) {
		...
		homePage.clickLogin();
		PopupHandler();
		homePage.clickTermsandConditionsCheckbox();
		homePage.clickTermsandConditionsButton();
	...
	public void verifyLoginWithInValidCredential() throws InterruptedException {
		 ...
		 */
		Assert.assertTrue(
				driver.findElement(By.xpath("//div[@data-pc-section='detail']/preceding-sibling::div")).isDisplayed());
	...
	public void verifyLoginWithoutCredential() {
		 ...
		 * xpath("//span[text()='Username is required.']")).isDisplayed());
		 */
