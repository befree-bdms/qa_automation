...
public class FoodMaster extends Base {
	...
	public void verifyAddFoodMaster() throws InterruptedException {
		...
		softAssert.assertTrue(msg.contains("Food already added for selected date"),
				"Expected message 'Food already added for selected date' not found.");

	}

	/*
	 * @Test public void verifyEmployeeCountFoodMaster() throws InterruptedException
	 * {
	 * 
	 * FoodMasterPage foodMasterPage = new FoodMasterPage(driver);
	 * 
	 * foodMasterPage.clickOnFilter(); Thread.sleep(1000);
	 * foodMasterPage.clickOnDateFilter(); Thread.sleep(100);
