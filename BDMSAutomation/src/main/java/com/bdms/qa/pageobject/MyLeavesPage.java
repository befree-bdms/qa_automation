...
public class MyLeavesPage {
	...
	// @FindBy(xpath="//windowmaximizeicon[@class='p-element p-icon-wrapper
	// ng-tns-c647991600-96 ng-star-inserted']")
	// @FindBy(xpath="//button[@class='ng-tns-c647991600-95 p-dialog-header-icon
	// p-dialog-header-maximize p-link ng-star-inserted']")
	...
	/*
	 * public void clickOnMaximizeWindow() { maximize.click(); }
	 */
